...
<body>
    <div>
        <h2>EASY Private NuGet.Server version<%= typeof(NuGetODataConfig).Assembly.GetName().Version %></h2>
        <p>
            Click <a href="<%= VirtualPathUtility.ToAbsolute("/NugetStorage/Packages") %>">here</a> to view your packages.
        </p>
        ...
        <fieldset style="width:800px">
            ...
            Click <a href="<%= VirtualPathUtility.ToAbsolute("/NugetStorage/clear-cache") %>">here</a> to clear the package cache.
        </fieldset>
        <% } %>
    </div>
</body>
