...
var CSharpHighlightRules = function () {
    var keywordMapper = this.createKeywordMapper({
        ...
        "constant.language": "null|true|false|or|not|is|as"
    }, "identifier");
    this.$rules = {
        "start": [
            {
...
define("ace/mode/foxpro_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module){"use strict";
var oop = require("../lib/oop");
var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
var FoxProHighlightRules = function () {
    var functions = ("Abs|Aclass|Acopy|Acos|Adatabases|Adbobjects|Addbs|Addproperty|Adel|Adir|Adlls|Adockstate|Aelement|Aerror|Aevents|Afields|" +
    ...
    var constants = ("\\.t\\.|\\.f\\.|\\.null\\.|null");
    var keywords = ("Additive|As|" +
        "By|Boolean|" +
        "Case|Catch|" +
        "Define|Do|" +
...
define("ace/mode/foxpro",["require","exports","module","ace/lib/oop","ace/mode/text","ace/tokenizer","ace/mode/foxpro_highlight_rules"], function(require, exports, module){"use strict";
var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
...
define("ace/mode/markdown",["require","exports","module","ace/lib/oop","ace/mode/behaviour/cstyle","ace/mode/text","ace/mode/javascript","ace/mode/json","ace/mode/xml","ace/mode/html","ace/mode/csharp","ace/mode/powershell","ace/mode/powershell","ace/mode/markdown_highlight_rules","ace/mode/folding/markdown","ace/mode/javascript","ace/mode/html","ace/mode/sh","ace/mode/sh","ace/mode/xml","ace/mode/css","ace/mode/csharp","ace/mode/csharp","ace/mode/json","ace/mode/javascript","ace/mode/powershell","ace/mode/powershell","ace/mode/foxpro"], function(require, exports, module){"use strict";
var oop = require("../lib/oop");
var CstyleBehaviour = require("./behaviour/cstyle").CstyleBehaviour;
var TextMode = require("./text").Mode;
var JavaScriptMode = require("./javascript").Mode;
